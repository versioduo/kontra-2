...
namespace {
  ...
  V2Device::Info    Info{V2DeviceInfo("com.versioduo.kontra-2", 35, "versioduo:samd:control")};
  V2LED::WS2812<2>  LED(PIN_LED_WS2812, sercom2, SPI_PAD_0_SCK_1, PIO_SERCOM);
  V2LED::WS2812<41> LEDExt(PIN_LED_WS2812_EXT, sercom1, SPI_PAD_0_SCK_1, PIO_SERCOM);
  ...
  public:
    Device() : V2Device() {
      ...
      usb.pid              = 0xe950; // https://github.com/versioduo/arduino-board-package/blob/main/boards.txt
