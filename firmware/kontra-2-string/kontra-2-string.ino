...
namespace {
  constexpr uint8_t        notesMax  = 30;
  constexpr uint8_t        nSteppers = 4;
  V2Device::Info           Info{V2DeviceInfo("com.versioduo.kontra-2-string", 52, "versioduo:samd:step")};
  V2LED::WS2812<nSteppers> LED(PIN_LED_WS2812, sercom2, SPI_PAD_0_SCK_1, PIO_SERCOM);
  ...
  struct Configuration Config{ConfigurationDefault};
  ...
  public:
    Device() : V2Device() {
      ...
      usb.pid              = 0xe960; // https://github.com/versioduo/arduino-board-package/blob/main/boards.txt
